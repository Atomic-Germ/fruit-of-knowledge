...
## Received Teaching
::: aside
"Build financial security first; give when what is left when you can."[^12] 

Society often teaches that accumulating wealth is a priority, and generosity is secondary. Not to say that giving is unimportant, but that it should come after ensuring one's own financial stability. The focus is on self-preservation and prudent management of resources as wise; generosity is seen as a discretionary act that should only occur when one has excess resources.
:::
